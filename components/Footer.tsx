      ...
      <div className={styles.container}>
        <div className={styles.grid}>
          ...
          <div className={styles.brandSection}>
            ...
            <p className={styles.brandDescription}>
              ...
              Every blade tells a story of craftsmanship and tradition.
            </p>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {currentYear} Cult of Athena Blades. All rights reserved.
          </p>
          <p className={styles.disclaimer}>
            All weapons sold for decorative and martial arts purposes only. Must be 18+ to purchase.
          </p>
        </div>
      </div>
    </footer>
